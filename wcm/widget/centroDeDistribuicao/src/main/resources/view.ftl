            ...
            <section class="row justify-content-center " style="display:flex;height: 100%;">
                ...
                <div class="col-8 animate d-flex align-items-center justify-content-center h-full">
                    <section class="menu">
                        ...
                        <button data-related-div="telaEntrada" href="#" class="btn btn-primary custom-menu-btn">
                        ...
                        <button data-related-div="telaSaida" href="#" class="btn btn-primary custom-menu-btn">
                        ...
                        <button data-related-div="telaConsulta" href="#" class="btn btn-primary custom-menu-btn">
